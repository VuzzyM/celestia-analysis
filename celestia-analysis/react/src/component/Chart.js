...
export class SysChart extends Component {
  ...
  componentDidMount(){
    const url = 'http://locahost:8000/api/sys';
    fetch(url)
    .then(res => res.json())
    .then(
      (result) =>{
...
export class CPUPercentChart extends Component {
  ...
  getCPUPercentData(){
    const url = 'http://locahost:8000/api/cpu_percent';
    fetch(url)
    .then(res => res.json())
    .then(
      (result) =>{
...
export class CPUCountChart extends Component{
  ...
  componentDidMount(){
    const url = 'http://locahost:8000/api/cpu_count';
    fetch(url)
    .then(res => res.json())
    .then(
      (result) =>{
...
export class CPUTimesChart extends Component{
  ...
  getCPUTimesData(){
    const url = 'http://locahost:8000/api/cpu_times';
    fetch(url)
    .then(res => res.json())
    .then(
      (result) =>{
...
export class NetSpeedChart extends Component{
  ...
  getNetSpeedData(){
    const url = 'http://locahost:8000/api/net_speed';
    fetch(url)
    .then(res => res.json())
    .then(
      (result) =>{
...
export class MemUsageChart extends Component{
  ...
  getMemUsageData(){
    const url='http://locahost:8000/api/mem_usage';
    fetch(url)
    .then(res =>res.json())
    .then(
      (result) =>{
...
export class DiskUsageChart extends Component{
  ...
  getDiskUsageData(){
    const url='http://locahost:8000/api/disk_usage';
    fetch(url)
    .then(res => res.json())
    .then(
      (result) =>{
...
export class NetInfoTable extends Component{
  ...
  getNetInfoData(){
    const url='http://locahost:8000/api/net_info';
    fetch(url)
    .then(res =>res.json())
    .then(
      (result) =>{
...
export class ProcInfoTable extends Component{
  ...
  getProcInfoData(){
    const url='http://locahost:8000/api/process';
    fetch(url)
    .then(res =>res.json())
    .then(
      (result) =>{
